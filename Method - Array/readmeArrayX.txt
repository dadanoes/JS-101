...
= Array adalah tipe data yang digunakan untuk menyimpan kumpulan data.
- acc adalah accumulator dan cur adalah current value
- tanda => arrow function (Secara harfiah berarti "menjadi" atau "mengembalikan".)
- tanda => Ini adalah pemisah antara argumen dan definisi fungsi.
- tanda {} = tanda kurung kurawal, digunakan untuk membungkus kode yang akan dieksekusi.
- tanda [] = tanda kurung siku, digunakan untuk membuat array.
- tanda . = tanda titik, digunakan untuk mengakses properti atau metode dari objek.
- tanda ; = tanda titik koma, digunakan untuk mengakhiri statement.
- tanda , = tanda koma, digunakan untuk memisahkan argumen atau elemen dalam array.
- tanda () = tanda kurung buka tutup, digunakan untuk memanggil fungsi atau mengisi argumen.
- i = index
- i++ = increment
...
- join(): Mengonversi elemen array menjadi string
